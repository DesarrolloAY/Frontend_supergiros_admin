...
function serialize_greet_HelloReply(arg) {
  if (!(arg instanceof Protos_greet_pb.HelloReply)) {
...
function deserialize_greet_HelloReply(buffer_arg) {
  return Protos_greet_pb.HelloReply.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_greet_HelloRequest(arg) {
  if (!(arg instanceof Protos_greet_pb.HelloRequest)) {
...
function deserialize_greet_HelloRequest(buffer_arg) {
  return Protos_greet_pb.HelloRequest.deserializeBinary(new Uint8Array(buffer_arg));
}
...
sayHello: {
    ...
    requestType: Protos_greet_pb.HelloRequest,
    responseType: Protos_greet_pb.HelloReply,
